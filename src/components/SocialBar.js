const icons = {
  discord: (
    <svg
      className="w-full h-full fill-current text-indigo-400 hover:text-indigo-300 duration-300"
      viewBox="0 0 24 24"
    >
      <path
        fillRule="evenodd"
...
const SocialBar = () => {
  return (
    <div className="grid grid-flow-col w-min items-center m-auto gap-10 mt-2">
      ...
      <div className="relative m-auto w-14 aspect-square cursor-pointer">
        <a
          href="https://www.linkedin.com/in/frederick-old/"
          target="_blank"
          rel="noreferrer"
        >
          {icons.linkedin}
      ...
      <div className="relative m-auto w-14 aspect-square cursor-pointer">
        <a
          className="mailto"
          href="mailto:frederick.bruce.old@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
          {icons.mail}

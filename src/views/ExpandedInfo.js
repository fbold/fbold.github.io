  ...
  return (
    <div className="flex w-full no-scrollbar">
      <div className="flex fixed items-center mt-auto top-0 h-full w-full bg-purple-even-darker z-0">
          {/* <div
            className="absolute top-5 h-14 w-14 cursor-pointer z-30 rounded-full bg-purple-even-darker invisible md:visible"
        ...
        <div className={`flex items-center relative h-full w-full font-bold z-10`}>
          <div className="flex relative flex-col md:pt-5 items-start md:items-center w-full h-full overflow-scroll no-scrollbar">
            <div className="hidden md:flex relative mr-auto ml-6 text-left text-gray-200 invisible md:visible cursor-pointer items-center"
              onClick={() => history.length > 2 ? history.goBack() : history.push('/')}>
